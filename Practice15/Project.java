	...
	public static void main(String[] args) {
		...
		try {
			TestCase[] tests = {
				...
				new TestCase("Test 2", "if statement is created", "Completion", 1),
			...
			if (!TestCase.compile(new File("Practice.java"))) {
				...
				tests[2].setResult(TestCase.runMain(".", "Practice", null, "(?s)abracadabra: Same start and finish letter!.*"));
			}
			...
			if (parser.parse("Practice.java")) {
				List<Statement> exps = parser.findStatements("void firstLastCheck(String)");
