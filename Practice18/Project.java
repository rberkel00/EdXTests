	...
	public static void main(String[] args) {
		...
		try {
			TestCase[] tests = {
				...
				new TestCase("Test 2", "Ternary statement is written", "Completion", 1),
			...
			if (!TestCase.compile(new File("Practice.java"))) {
				...
				tests[2].setResult(TestCase.runMain(".", "Practice", null, "(?s).*I have 1 pizza\\..*I have 10 pizzas.*I have 0 pizzas?\\..*"));
			}
