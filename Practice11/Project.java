	...
	public static void main(String[] args) {
		...
		try {
			TestCase[] tests = {
				...
				new TestCase("Test 2", "if statement is used (and syntax is correct)", "Completion", 1),
				new TestCase("Test 3", "if statement is correct", "Completion", 1)
			};
			...
			if (!TestCase.compile(new File("Practice.java"))) {
				...
				tests[2].setResult(TestCase.runMain(".", "Practice", null, "(?s).*The number 103 is the biggest!.*"));
			}
