	...
	public static void main(String[] args) {
		...
		try {
			TestCase[] tests = {
				...
				new TestCase("Test 2", "for loop is created", "Completion", 1),
				new TestCase("Test 3", "output is correct (prints PQRSTU)", "Completion", 1)
			};
			...
			if (!TestCase.compile(new File("Practice.java"))) {
				...
				tests[2].setResult(TestCase.runMain(".", "Practice", null, "(?s).* PQRSTU .*"));
			}
