...
public class CardCollection {
  ...
  public static void main(String[] args) {
    ...
    aa.addCard(c);
    aa.addCard(b);
    if (aa.getSize() != 3 || !aa.myCollection.get(0).toString().matches(".*B.*") || !aa.myCollection.get(0).toString().matches(".*C.*")
      || !aa.myCollection.get(0).toString().matches(".*R.*"))
    ...
    if (aa.getSize() != 2) System.out.println("getSize failed");

    bb.addCard(a);
    bb.addCard(b);
    List<Card> dups = aa.mergeCollections(bb);
    if (bb.getSize() != 0) System.out.println("mergeCollections 2 failed");
    if (aa.getSize() != 3 || !aa.myCollection.get(0).toString().matches(".*B.*") || !aa.myCollection.get(0).toString().matches(".*C.*")
      || !aa.myCollection.get(0).toString().matches(".*R.*"))
      System.out.println("mergeCollections 3 failed");
    if (dups.size() != 1 || !dups.get(0).toString().matches(".*C.*")) System.out.println("mergeCollections 1 failed");
